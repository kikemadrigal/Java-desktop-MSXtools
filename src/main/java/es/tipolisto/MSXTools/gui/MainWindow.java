...
public class MainWindow extends JFrame {
	...
	public MainWindow() {
		...
		JLabel lblNewLabel_1 = new JLabel("MSX spain 2023 ");
		...
		JButton btnCreateLineNumbers = new JButton("Create line numbers");
		btnCreateLineNumbers.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				CreateLineNumbersWindow frame = new CreateLineNumbersWindow();
				frame.setVisible(true);
			}
		});
		btnCreateLineNumbers.setBounds(559, 259, 231, 23);
		contentPane.add(btnCreateLineNumbers);
	}
}
