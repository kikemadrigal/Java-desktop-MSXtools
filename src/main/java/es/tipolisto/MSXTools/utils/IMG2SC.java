...
public class IMG2SC{
	...
	*/
	...
	public StringBuilder getPNGIndexedhexadecimalStringBuilder(BufferedImage bufferedImage, int similarDistance) {
		StringBuilder sb=new StringBuilder();
		HashMap<MSXPalette, RGB> palettePhilips8255NMS=PaletteManager.getPalettePhilips8255NMS();
        String result="";
        BufferedImage bufferedImageDestiny=new BufferedImage(256, 212, BufferedImage.TYPE_INT_RGB);
	...
	public void createFileWithString(StringBuilder result, String abosultePathFileOrigin, String stringFileName) throws IOException {
		...
		String absolutePathDestiny=abosultePathFileOrigin.substring(0,abosultePathFileOrigin.lastIndexOf("\\"));
		String fileDestinyAbsolutePath=absolutePathDestiny+"\\"+fileName;
	    FileOutputStream fos;
		fos = new FileOutputStream(fileDestinyAbsolutePath);
		fos.write(header);
	    fos.write(data);
	    fos.close();
	}
	public void createFileWithStringSC2(byte[] data, String abosultePathFileOrigin, String stringFileName) throws IOException {
		//System.out.println("tamaño: "+result.length());
